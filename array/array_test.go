...
func TestMinAndMax(t *testing.T) {
	...
	comparator := func(arg0, arg1 int) int {
		if arg0 > arg1 {
			return 1
		} else if arg0 < arg1 {
			return -1
	...
	if v, found := array.Min(comparator); !found || v != 1 {
		t.Fatal("wrong min")
	}

	if v, found := array.Max(comparator); !found || v != 5 {
		t.Fatal("wrong max")
	}
}
...
func TestDeleteKeepOrdering(t *testing.T) {
	...
	if !array.IsSorted(func(arg0, arg1 int) int {
		if arg0 > arg1 {
			return 1
		} else if arg0 < arg1 {
			return -1
